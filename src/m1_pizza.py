...
Authors: David Mutchler, Dave Fisher, Valerie Galluzzi, Amanda Stouder,
         their colleagues and Daniel Johnson.
...
def run_test_generate_points_on_circle():
    ...
    # Test 2:
    expected = [rg.Point(125.0, 100.0),  # All numbers are approximate.
                rg.Point(75.0, 100.0)]
    circle = rg.Circle(rg.Point(100, 100),
                       25)
...
def run_test_draw_points_on_circle():
    ...
    # ------------------------------------------------------------------
    # Test 4:
    title = 'Test 4:  90 red dots.'
    window = rg.RoseWindow(400, 400, title)
    circle = rg.Circle(rg.Point(200, 200), 175)
    draw_points_on_circle(window, circle, 90, 'red')
    window.close_on_mouse_click()
...
def draw_points_on_circle(window, circle, number_of_points, color):
    ...
    for k in range(len(points)):
        newCircle = rg.Circle(points[k], 10)
...
def run_test_pizza():
    ...
    # ------------------------------------------------------------------
    # Test 4:
    title = 'PIZZA test 4:  8 slices, thin (thickness=2) black lines.'
    window = rg.RoseWindow(400, 400, title)
    circle = rg.Circle(rg.Point(200, 200), 150)
    circle.outline_thickness = 2
    circle.fill_color = "yellow"
    pizza(window, circle, 8, 'black', 2)
    window.close_on_mouse_click()
...
def run_test_polygon():
    ...
    # ------------------------------------------------------------------
    title = "Test 3 with a square with thin purple lines"
    window = rg.RoseWindow(400, 400, title)
    circle = rg.Circle(rg.Point(200, 200), 100)
    circle.outline_thickness = 3
    polygon(window, circle, 4, 'purple', 2)
    window.close_on_mouse_click()
...
def run_test_fancy_polygon():
    ...
    title = 'FANCY POLYGON test 4:  300 red lines' + \
        ' on blue circle, hops = 61.'
    window = rg.RoseWindow(480, 350, title)
